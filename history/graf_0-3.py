...
def main(c1, xmin, xmax, ymin, ymax):
...
print()
xmi = float(input('Digite o valor mínimo de x: '))
xma = float(input('Digite o valor máximo de x: '))
if xma < xmi:
    while xma < xmi:
        print('\033[31mERRO!!! O x máximo tem de ser maior que o x mínimo!\033[m')
        xma = float(input('Digite novamente: '))
ymi = float(input('Digite o valor mínimo de y: '))
yma = float(input('Digite o valor máximo de y: '))
if yma < ymi:
    while yma < ymi:
        print('\033[31mERRO!!! O y máximo tem de ser maior que o y mínimo!\033[m')
        yma = float(input('Digite novamente: '))

main(c, xmi, xma, ymi, yma)
